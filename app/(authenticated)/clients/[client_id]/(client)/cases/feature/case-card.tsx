    ...
    return (
        ...
        */}
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1.5 text-[8px] text-muted-foreground">
                    <span>
                        <strong className="font-mono text-foreground">{item.movementsCount}</strong>{' '}
                        movimentos
                    </span>

                    <span>
                        <strong className="font-mono text-foreground">{item.documentsCount}</strong>{' '}
                        documentos
                    </span>

                    <span>
                        <strong className="font-mono text-foreground">{item.deadlinesCount}</strong>{' '}
                        prazos
                    </span>
                </div>
                ...
                <div className="grid gap-0.5 border-l-2 border-primary/65 pl-2.5">
                    ...
                    <small className="text-[8px] text-muted-foreground">
                        {item.nextDeadline ? formatDate(item.nextDeadline.dueAt) : 'Monitoramento'}
                    </small>
                </div>
            </div>

            <footer className="flex min-h-13 items-center justify-between gap-3 border-t px-3.5 pr-1.5 text-[9px] text-muted-foreground">
                <span className="truncate">Movimentado {formatUpdatedAt(item.updatedAt)}</span>
