...
const CasesPage = async ({ params, searchParams }: CasesPageProps) => {
    ...
    return (
            ...
            <header className="flex flex-wrap items-end justify-between gap-4">
                <div className="grid gap-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Processos vinculados a este cliente, com origem, andamento e próximos
                        marcos.
                    </p>
                </div>

                <Button asChild>
                    <Link href={buildClientIntakesHref(clientId)}>Ver fichas finalizadas</Link>
                </Button>
            </header>
      ...
      */}
            <Suspense key={JSON.stringify(filterParams)} fallback={<CasesGridSkeleton />}>
