...
export const ClientIdentificationPanel = () => {
    ...
    return (
        <FormPanel title="Identificação" description="Tipo, nome e documento principal do cliente.">
            <div className="grid gap-4 sm:grid-cols-2">
                <Field className="sm:col-span-2">
                    <FieldLabel htmlFor="client-type-PESSOA_FISICA">Tipo de cliente</FieldLabel>
                ...
                <Field data-invalid={Boolean(errors.document)}>
                    ...
                    {errors.document ? <FieldError>{errors.document.message}</FieldError> : null}
                </Field>
