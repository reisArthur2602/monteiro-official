...
const DocDataItem = ({ label, value, fullWidth }: DocDataItemProps) => (
    <div className={fullWidth ? 'col-span-2 grid gap-[1mm]' : 'grid gap-[1mm]'}>
        <span className="font-sans text-[7.5pt] font-bold uppercase" style={{ color: LABEL_GRAY }}>
            {label}
        </span>
...
export const AttendanceDocumentPreview = ({
    ...
    const clientSignerName = form.contactPerson || client.displayName || client.name;
