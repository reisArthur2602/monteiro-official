...
export const generateMetadata = async ({
    ...
    const form = await getAttendanceFormDetail(parsedClientId.data, parsedFormId.data);

    return { title: form?.subject || 'Ficha de atendimento' };
};

const AttendanceFormDetailPage = async ({ params }: AttendanceFormDetailPageProps) => {
    const { client_id: rawClientId, form_id: rawFormId } = await params;
    ...
    return (
        <div className="grid gap-4">
            ...
            <div className="grid items-start gap-4 lg:grid-cols-[20rem_minmax(0,1fr)]">
                ...
                <AttendanceDocumentPreview office={office} client={client} form={form} />
            </div>
