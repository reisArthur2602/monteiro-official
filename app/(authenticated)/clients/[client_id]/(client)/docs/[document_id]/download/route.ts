 ...
 */
export const GET = async (_request: Request, { params }: DownloadRouteContext) => {
    try {
        ...
        const document = await getClientDocumentFile(parsedClientId.data, parsedDocumentId.data);
