...
-- CreateEnum
CREATE TYPE "ProcessDocumentRole" AS ENUM ('PETICAO', 'DECISAO', 'SENTENCA', 'ACORDAO', 'CONTRATO', 'PROCURACAO', 'COMPROVANTE', 'PROVA', 'DOCUMENTO_CLIENTE', 'DOCUMENTO_PARTE_CONTRARIA', 'OUTRO');

-- CreateEnum
CREATE TYPE "ProcessDeadlineStatus" AS ENUM ('ABERTO', 'EM_ANDAMENTO', 'CONCLUIDO', 'CANCELADO', 'VENCIDO');

-- CreateEnum
CREATE TYPE "ProcessActivityType" AS ENUM ('PROCESSO_CRIADO', 'PROCESSO_ATUALIZADO', 'STATUS_ALTERADO', 'MOVIMENTACAO_CRIADA', 'DOCUMENTO_VINCULADO', 'DOCUMENTO_DESVINCULADO', 'PRAZO_CRIADO', 'PRAZO_ATUALIZADO', 'PRAZO_CONCLUIDO', 'PARTE_ADICIONADA', 'PARTE_ATUALIZADA', 'RESPONSAVEL_ALTERADO', 'OUTRO');
...
CREATE TABLE "process_documents" (
    ...
    "movement_id" UUID,
    "role" "ProcessDocumentRole" NOT NULL DEFAULT 'OUTRO',
    "notes" VARCHAR(500),
    "position" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "process_documents_process_id_role_deleted_at_idx" ON "process_documents"("process_id", "role", "deleted_at");

-- CreateIndex
CREATE INDEX "process_documents_process_id_position_idx" ON "process_documents"("process_id", "position");

-- CreateIndex
CREATE INDEX "process_documents_client_document_id_idx" ON "process_documents"("client_document_id");

-- CreateIndex
CREATE INDEX "process_documents_movement_id_idx" ON "process_documents"("movement_id");

-- CreateIndex
CREATE INDEX "process_documents_role_idx" ON "process_documents"("role");

-- CreateIndex
CREATE INDEX "process_documents_added_by_id_idx" ON "process_documents"("added_by_id");

-- CreateIndex
CREATE UNIQUE INDEX "process_documents_process_id_client_document_id_key" ON "process_documents"("process_id", "client_document_id");
...
-- AddForeignKey
ALTER TABLE "process_documents" ADD CONSTRAINT "process_documents_client_document_id_fkey" FOREIGN KEY ("client_document_id") REFERENCES "client_documents"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "process_documents" ADD CONSTRAINT "process_documents_added_by_id_fkey" FOREIGN KEY ("added_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
